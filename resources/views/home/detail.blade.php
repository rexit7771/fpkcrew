    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-12 mx-auto">
                <form action="{{route('approval')}}" method="post" class="custom-form membership-form shadow-lg" role="form">
                    @csrf
                    ...
                    <table class="table text-center">
                        ...
                        <tbody>
                            @foreach ($list_approve as $key)
                            <tr>
                                <td><i class="bi-check-circle-fill " style="color: #81B29A"></i></td>
                                <td style="color: #ffff">
                                    {{$key->nama}} 
                                <br/> {{$key->note}} </td>
                            </tr>
                            @endforeach
                            @foreach ($list_reject as $key)
                            <tr>
                                <td><i class="bi-x-circle-fill " style="color:  #E07A5F"></i></td>
                                <td style="color: #ffff">{{$key->nama}}
                                    <br/> {{$key->note}} </td>
                            </tr>
                            @endforeach
                        </tbody>
